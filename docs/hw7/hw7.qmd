...
spec <- as_vegaspec(list(
  ...
  data = list(
    values = list(
      list(rank = 1, title = "Star Wars: The Last Jedi", title_short = "Star Wars", amount = 71565498),
      list(rank = 2, title = "Jumanji: Welcome to the Jungle", title_short = "Jumanji", amount = 36169328),
      list(rank = 3, title = "Pitch Perfect 3", title_short = "Pitch Perfect 3", amount = 19928525),
      list(rank = 4, title = "The Greatest Showman", title_short = "Greatest Showman", amount = 8805843),
      list(rank = 5, title = "Ferdinand", title_short = "Ferdinand", amount = 7316746)
    )
  ),
  mark = "bar",
  encoding = list(
...
spec <- as_vegaspec(list(
  ...
  encoding = list(
    ...
    color = list(
      ...
      title = "Race",
      scale = list(
        domain = list("Asian", "white", "Hispanic", "black"),
        range = list("#D55E00", "#0072B2", "#009E73", "#CC79A7")
      )
    )
  ),
  width = 450,
...
spec <- as_vegaspec(list(
  `$schema` = "https://vega.github.io/schema/vega-lite/v5.json",
  title = "Internet adoption over time, for select countries",
  data = list(
  ...
  encoding = list(
    ...
    tooltip = list(
      ...
      list(field = "users", type = "quantitative", title = "Internet users / 100")
    )
  ),
  width = 600,
  height = 400
...
spec <- as_vegaspec(list(
  ...
  encoding = list(
    ...
    color = list(
      ...
      scale = list(
        ...
        range = list("#5A5A5A", "#C75D5D", "#E8D84E")
      ),
      legend = NULL
    ),
    order = list(
  ...
  layer = list(
    list(
      mark = list(type = "arc", innerRadius = 0)
    ),
    list(
      mark = list(type = "text", radius = 150, fontSize = 18, fontWeight = "bold"),
      encoding = list(
        text = list(field = "seats", type = "quantitative")
      )
    ),
    list(
      mark = list(type = "text", radius = 230, fontSize = 16),
      encoding = list(
